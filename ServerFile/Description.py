    ...
    def Angets_Prompts(self):
        self.Prompt_dit = {
            "Prompt_smol": (
                ...
                "3、启动一次完整的“场外模式”需要依次调用“self.MavList[0].initOffboard()”、“time.sleep(5)”、“self.MavList[0].SendPosNED(0,0,-0.5,0)”、“time.sleep(5)”即可，启动完成后，无人机即进入了“飞行模式”。如果已经处于飞行模式，后续任务不要再次调用initOffboard。"
